(() => {
    ...
    window.addEventListener("load", windowLoad2);
    function windowLoad2() {
        const checkbox2 = document.getElementById("togglePrice");
        if (checkbox2) {
            const priceItms = document.querySelectorAll(".top-price__item");
            checkbox2.addEventListener("change", (() => {
                if (checkbox2.checked) priceItms.forEach((price => price.classList.add("annual"))); else priceItms.forEach((price => price.classList.remove("annual")));
            }));
        }
    }
    window["FLS"] = true;
